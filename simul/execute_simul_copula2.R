rm(list = ls())
################ copula data generation scenario 2 ###################
scenario = 2 # rho = 0.2
...
# data generation
source("simul/simul_data_copula.R")
# lbp
source("R/polya.R")
...
results = foreach(isim = 1:nsims,
                  ...
                  .combine = "c") %dopar% {
                    ...
                    out_dir <- paste0("simul/output_copuladatafit/scenario",scenario,"/simulation_",isim)
                    if(!dir.exists(out_dir)){
                      dir.create(out_dir)
                    }
                    # step 1: data generation and set seed
                    data <- simulate_data_copula(n = n, ntest = ntest, seed = isim, scenario = scenario)
