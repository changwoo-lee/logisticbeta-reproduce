...
#' @param Phi normalized feature map basis matrix for LBP
...
#'
#' @examples
LBDDP_basis = function(y, X, Phi, b = 1, H = 20, prior = NULL, nburn = 100, nsave = 1000, nthin = 1)
{
  ...
  lambda_save = array(0, dim = c(nsave, H))
